module applytypes_demo {
    ...
    //string array
    function getarrayLength(array: string[]) {
        var len: number = array.length;
        return len;
    }

    var names: string[] = ["firstPerson", "secondPerson", "thirdPerson"];
    var firstPerson: string = names[0];  // firstPerson has annotation to string
    ...
    //null
    var computer: any = null;
    var people = null;
    var orderDate: Date = null;

    //undefined
    var quantity: number; // number but it has no value and hence it is undefined as well.
